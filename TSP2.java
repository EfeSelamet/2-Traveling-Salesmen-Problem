...
public class TSP2 {
    ...
    public static Point centeroid_0 = new Point(25000, 25000, -1); // adjust centeroids
    public static Point centeroid_1 = new Point(300000, 300000, -2);
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Distance Before 2opt Optimization: "+ calculateTourDistance(cluster_0_path, cluster_0_adj, cluster_0_cities));
        cluster_0_path = optimize2Opt(cluster_0_path, cluster_0_adj,cluster_0_cities);
        System.out.println("Distance After 2opt Optimization: "+ calculateTourDistance(cluster_0_path, cluster_0_adj,cluster_0_cities));
        ...
        try (PrintWriter writer = new PrintWriter("outputFileThirdInput.txt")) {    ///////// Thirs change
    ...
    public static double calculateTourDistance(ArrayList<Integer> tour, double[][] distanceMatrix,ArrayList<Point> sortedList) {
        //System.out.println("Distance is being calcluted.");
